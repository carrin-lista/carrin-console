...
import { Users, Home, ShoppingBag, Headset, Info, Clock } from 'lucide-react';
...
export function Analytics() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {/* Page Header Padronizado (Sem ícone no H1, subtítulo limpo e filtro de período alinhado à direita) */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2">
        ...
        <div className="flex items-center gap-2.5 w-full sm:w-auto bg-white p-1.5 rounded-xl border border-gray-200/80 shadow-sm">
          <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider pl-2">Período:</span>
          <select 
            value={days} 
            onChange={(e) => setDays(Number(e.target.value))}
            className="px-3 py-1.5 bg-gray-50/60 border border-gray-200 rounded-lg text-xs font-bold text-gray-700 focus:outline-none focus:ring-1 focus:ring-emerald-500 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-blue-50/60 rounded-xl p-4 border border-blue-100/80">
                <p className="text-[11px] font-bold text-blue-500 uppercase tracking-wider">Novos no Período</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-emerald-50/60 rounded-xl p-4 border border-emerald-100/80">
                <p className="text-[11px] font-bold text-emerald-600 uppercase tracking-wider">Ticket Médio (Por Compra)</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-purple-50/60 rounded-xl p-4 border border-purple-100/80">
                <p className="text-[11px] font-bold text-purple-500 uppercase tracking-wider">Criadas no Período</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6 space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex-1 bg-red-50/50 rounded-xl p-4 border border-red-100/80">
                <p className="text-[11px] font-bold text-red-500 uppercase tracking-wider">Abertos</p>
                <p className="text-2xl font-extrabold text-red-500 mt-1">{data.support.open}</p>
              </div>
              <div className="flex-1 bg-emerald-50/50 rounded-xl p-4 border border-emerald-100/80">
                <p className="text-[11px] font-bold text-emerald-600 uppercase tracking-wider">Resolvidos</p>
                <p className="text-2xl font-extrabold text-emerald-600 mt-1">{data.support.resolved}</p>
              </div>
            </div>

            <div className="bg-gray-50 border border-gray-200/80 rounded-xl p-4 flex items-start gap-3">
